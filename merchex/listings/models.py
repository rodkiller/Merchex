...
class Title(models.Model):
    def __str__(self):
         return f'{self.name}'  # cette methode permet d afficher le nom dans le site admin
    ...
    sold = models.fields.IntegerField(validators=[MinValueValidator(0), MaxValueValidator(100)])
